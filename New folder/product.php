<?php include 'all php/header.php'; ?>
    ...
    <div class="prolog">
        <div class="prolog-in">
            <div class="gestwrp">
                <div class="guestlft">
                    <img src="images/about us/guest-photo.png">
                    <p>Guest User</p>
                </div>
                <div class="guestclose">
                    <img src="images/about us/log-close.png">
                </div>
            </div>
        ...
        <div class="dontacc">
            ...
            <a href="register.html">Create an account <span><img
                        src="images/about us/red-angle-right.png"></span></a>
        </div>
    </div>
						...
						<div class="item">
							<div class="productbox wow  fadeInUp" data-wow-duration="1s"
								...
								<div class="productbox-img">
									...
									<input type="hidden" name="item_name" value="PUSHAL SAFFRON">
						...
						<div class="item">
							<div class="productbox wow  fadeInUp" data-wow-duration="1s"
								...
								<div class="productbox-img">
									...
									<div class="border-btn mt-4 __web-inspector-hide-shortcut__">
										<a href="product.php" class="cart-btn-right"> <button>See More</button></a>
										<a href="product.php" class="cart-btn-left"> <button type="submit" name="Add_to_cart">Add to cart</button></a>
									</div>
									<input type="hidden" name="item_name" value="SARGOL SAFFRON">
								...
								<div class="product-subtitle">
									<div class="product-subtitle-in">
										<h4>SARGOL SAFFRON</h4>
										<span>Saffron Strands</span>
										<div class="star-rating">
									</div>
									</div>
									<p class="amount">₹ 800.00</p>
								</div>
							</div>
						</div>
						</form>
						...
						<div class="item">
							<div class="productbox wow  fadeInUp" data-wow-duration="1s"
								...
								<div class="productbox-img">
									...
									<input type="hidden" name="item_name" value="BUNCH SAFFRON">
					...
					<div class="col-md-4 col-12 pad-0">
						<div class="item">
							<div class="productbox wow  fadeInUp" data-wow-duration="1s"
								data-wow-delay="0.5s">
								<div class="productbox-img">
									<img src="images/Artboard 2_546.png">
										<div class="productbox-hover fadeIn-bottom">
											<a href="#">See More</a>
					...
					<div class="col-md-4 col-12 pad-0">
						<div class="item">
							<div class="productbox wow  fadeInUp" data-wow-duration="1s"
								data-wow-delay="0.5s">
								<div class="productbox-img">
									<img src="images/Artboard 11.png">
										<div class="productbox-hover fadeIn-bottom">
											<a href="#">See More</a>
				...
				<div class="col-lg-6 col-md-8 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.5s">
					...
					<div class="stepwrp">
						<ul>
							<li>
								<h4>Step 1</h4>
								<p>Baby Brand Saffron Gift Box is a true emblem of your vision & requirements,
            ...
            <div class="communityslide">
              <div id="community-slide" class="owl-carousel owl-theme">
                ...
                <div class="item wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.5s"><img
                    src="images/insta-feed-04.png"></div>
